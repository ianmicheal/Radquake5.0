...
cvar_t	r_waterwarp = {"r_waterwarp","0", true};	//speud - save to config file

//cvar_t	r_fullbright = {"r_fullbright","0"};
cvar_t	r_fullbright = {"r_fullbright","0", true};	//speud - save to config file

//cvar_t	r_drawentities = {"r_drawentities","1"};
cvar_t	r_drawentities = {"r_drawentities","1", true};	//speud - save to config file

//cvar_t	r_drawviewmodel = {"r_drawviewmodel","1"};
cvar_t	r_drawviewmodel = {"r_drawviewmodel","1", true};	//speud - save to config file
